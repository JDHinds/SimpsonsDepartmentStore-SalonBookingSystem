    ...
    class WaterMarkTextBox :  TextBox
    {
        ...
        private void JoinEvents(Boolean join)
        {
            if (join)
            {
                ...
                //No one of the above events will start immediatly 
                //TextBox control still in constructing, so, Font object (for example) couldn't be catched from within WaterMark_Toggle
                //So, call WaterMark_Toggel through OnCreateControl after TextBox is totally created
                //No doubt, it will be only one time call
            }
        }
